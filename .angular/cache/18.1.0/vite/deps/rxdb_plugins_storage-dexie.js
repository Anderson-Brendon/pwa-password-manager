...
var RxStorageInstanceDexie = function() {
  ...
  _proto.bulkWrite = function bulkWrite(documentWrites, context) {
    return __async(this, null, function* () {
      ...
      if (!shownNonPremiumLog && (!RXDB_UTILS_GLOBAL.premium || typeof RXDB_UTILS_GLOBAL.premium !== "string" || (yield defaultHashSha256(RXDB_UTILS_GLOBAL.premium)) !== PREMIUM_FLAG_HASH)) {
